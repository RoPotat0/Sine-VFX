...
- Combine the Library with the [graph editor](/windows/graph-editor): pick a texture, then
  shape its transparency and size curves for the final look.
- For animated sprite sheets, set the **Flipbook** options in
  [Properties](/windows/properties) after applying the texture.
