...
Open **Settings** from the [Hub](/windows/overview) to configure the plugin's look and
behaviour. Settings persist between sessions.

## Button Layout

Choose which **corner** the Hub FAB sits in — bottom‑right (default), bottom‑left,
